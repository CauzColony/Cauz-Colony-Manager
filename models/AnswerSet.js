...
var AnswerSet = new keystone.List('AnswerSet', {
  noedit: true,
  nocreate: true,
  nodelete: true,
  //hidden: true
...
AnswerSet.add({
  project: { type: Types.Relationship, ref: 'Project', required: true },
  answers: { type: Types.Relationship, ref: 'Answer', many: true, required: true },
