...
Charity.add({
  ...
  logoLarge: { type: Types.CloudinaryImage, autoCleanup : true, note: 'sized to exactly 600x280 on a white background'},
  logoSmall: { type: Types.CloudinaryImage, autoCleanup : true, note: 'sized to exactly 300x140 on a white background'}
});
